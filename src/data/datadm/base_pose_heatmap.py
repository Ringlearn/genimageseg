...
from pose_transforms import get_affine_transform
from pose_transforms import affine_transform
from pose_transforms import fliplr_joints
...
class JointsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return input, target, target_weight, meta, prompt,original_image

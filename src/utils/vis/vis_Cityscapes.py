...
def visualize_segments(root_image, root_mask):
    vis_list = os.listdir(root_image)
    mask_lsit = os.listdir(root_mask)
    os.makedirs("sample/datadm/Vis", exist_ok=True)
    ...
    #     try:
        ...
        vis_output.save("sample/datadm/Vis/{}".format(image_pa))
        break

visualize_segments(root_image, root_mask)